...
type Interface interface {
	...
	VirtualSecretsV1alpha1() virtualsecretsv1alpha1.VirtualSecretsV1alpha1Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	virtualSecretsV1alpha1 *virtualsecretsv1alpha1.VirtualSecretsV1alpha1Client
}
...
func (c *Clientset) VirtualSecretsV1alpha1() virtualsecretsv1alpha1.VirtualSecretsV1alpha1Interface {
	return c.virtualSecretsV1alpha1
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.virtualSecretsV1alpha1, err = virtualsecretsv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.virtualSecretsV1alpha1 = virtualsecretsv1alpha1.New(c)
